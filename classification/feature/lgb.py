...
def train_lgbm(seq_length, dimension, train_path, valid_path):
    ...
    print("Validation Accuracy: {:.4f}".format(acc_valid))
    print("Validation F1 (micro): {:.4f}".format(f1_valid))
...
def main():
    parser = argparse.ArgumentParser(
        description="Train LightGBM on anomalous diffusion handcrafted features."
    )
