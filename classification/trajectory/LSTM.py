...
def train_lstm(seq_length, dimension, train_path, valid_path):
    ...
    model = LSTMModel(dimension, HIDDEN_DIM, LAYER_DIM, NUM_CLASSES).to(device)
...
def main():
    ...
    train_lstm(args.length, args.dimension, args.train_path, args.valid_path)
