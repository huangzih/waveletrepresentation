...
def train_gru_reg(seq_length, dimension, train_path, valid_path):
    ...
    model = GRURegressor(dimension, HIDDEN_DIM, LAYER_DIM, 1).to(device)
...
def main():
    ...
    train_gru_reg(args.length, args.dimension, args.train_path, args.valid_path)
