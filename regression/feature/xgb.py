...
def train_xgb(seq_length, dimension, train_path, valid_path):
...
def main():
    parser = argparse.ArgumentParser(
        description="Train XGBoost regressor on anomalous diffusion handcrafted features."
    )
    ...
    train_xgb(args.length, args.dimension, args.train_path, args.valid_path)
