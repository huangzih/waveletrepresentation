...
def train_linreg(seq_length, dimension, train_path, valid_path):
    ...
    print("Validation MAE: {:.4f}, MSE: {:.4f}".format(mae_valid, mse_valid))
...
def main():
    ...
    train_linreg(args.length, args.dimension, args.train_path, args.valid_path)
